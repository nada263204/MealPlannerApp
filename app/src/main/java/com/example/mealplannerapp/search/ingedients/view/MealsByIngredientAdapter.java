...
public class MealsByIngredientAdapter extends RecyclerView.Adapter<MealViewHolder> {
    private List<MealByIngredient> mealsList;
    private OnMealClickListener listener;

    public MealsByIngredientAdapter(List<MealByIngredient> mealsList, OnMealClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull MealViewHolder holder, int position) {
        MealByIngredient meal = mealsList.get(position);
    ...
    public void updateMeals(List<MealByIngredient> newMeals) {
